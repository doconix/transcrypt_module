...
function main(){function e(a){return void 0===a||null===a?!1:0<=["boolean","number"].indexOf(typeof a)?a:a.__bool__ instanceof Function?a.__bool__()?a:!1:a.__len__ instanceof Function?0!==a.__len__()?a:!1:a instanceof Function?a:0!==x(a)?a:!1}function g(a){this.iterable=a;this.index=0}function f(a){this.iterable=a;this.index=0}function h(a,b,d){void 0==b&&(b=a,a=0);void 0==d&&(d=1);if(0<d&&a>=b||0>d&&a<=b)return[];for(var c=[];0<d?a<b:a>b;a+=d)c.push(a);return c}function w(a){if(null==a||"object"==
...
c,e],f):a.__setslice__(b,c,e,f)};(function(){var a=function(a,b){return a+b},b=function(){return a};if("object"===typeof module&&module.exports)module.exports=a;else if("function"===typeof define&&define.amd)define(l([]),b);else{var d=a;window[d.name]=d}c.__name__="__main__";c.addnums=a;c.f=d;c.factory=b})();return c}main();
